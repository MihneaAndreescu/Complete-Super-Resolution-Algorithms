...
def generateInputFromOutput(outputImg):
    ...
    inputImg = cv2.resize(inputImg, (0,0), fx = 2, fy = 2)
...
class awesomepreUpsampling(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 4, kernel_size = 5, padding = 2, padding_mode = 'replicate')
        self.conv2 = nn.Conv2d(4, 4, kernel_size = 5, padding = 2, padding_mode = 'replicate')
        self.conv3 = nn.Conv2d(4, 4, kernel_size = 5, padding = 2, padding_mode = 'replicate')
        self.conv4 = nn.Conv2d(4, 4, kernel_size = 5, padding = 2, padding_mode = 'replicate')
        self.conv5 = nn.Conv2d(4, 4, kernel_size = 5, padding = 2, padding_mode = 'replicate')
        self.conv6 = nn.Conv2d(4, 1, kernel_size = 5, padding = 2, padding_mode = 'replicate')
